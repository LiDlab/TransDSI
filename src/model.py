...
class VGAE(nn.Module):
    """
    Self-supervised module for embedding protein sequence features
    """
    def __init__(self, input_feat_dim, hidden_dim1, hidden_dim2, dropout):
        super(VGAE, self).__init__()
        self.gc1 = GCNLayer(input_feat_dim, hidden_dim1, dropout)
        self.gc2 = GCNLayer(hidden_dim1, hidden_dim2, dropout)
...
class DSIPredictor(nn.Module):
    """
    Semi-supervised module for DSI prediction
    """
